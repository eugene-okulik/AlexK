my_dict = {"tuple": (1, 2, 3, 4, 5),
    ...
    "dict": {"name": "Alice","city": "London","color": "blue","language": "Python","year": 2025},
...
my_dict["dict"]["i am a tuple"] = "value"  #  добавьте элемент с ключом ('i am a tuple',) и любым значением
print(my_dict["dict"])
